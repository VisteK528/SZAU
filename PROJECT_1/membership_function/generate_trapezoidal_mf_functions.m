function [mf_h1, mf_h2] = generate_trapezoidal_mf_functions(N)
    ...
    mf_h2(N, 1) = fismf();
    for i = 1:N
        h2_center = h2_pp_min + step_h2 * (i-1);
        h2_left = h2_center - step_h2 / 1.5; 
        h2_right = h2_center + step_h2 / 1.5; 
        h2_top_left = h2_left + step_h2 / 3; 
        h2_top_right = h2_right - step_h2 / 3; 
        
        h1_center = h1(h2_pp_min) + step_h1 * (i-1);
        h1_left = h1_center - step_h1 / 1.5;
        h1_right = h1_center + step_h1 / 1.5;
        h1_top_left = h1_left + step_h1 / 3;
        h1_top_right = h1_right - step_h1 / 3;
